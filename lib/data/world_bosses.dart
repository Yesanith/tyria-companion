...
final worldBosses = <WorldBoss>[
  ...
  // Heart of Thorns
  WorldBoss('verdant_brink_night_night_and_the_enemy', "Night: Night and the Enemy", "Verdant Brink", _every(_t(1, 45), 120),
      expansion: Expansion.hot),
  WorldBoss('verdant_brink_night_bosses', "Night Bosses", "Verdant Brink", _every(_t(0, 10), 120),
      expansion: Expansion.hot),
  WorldBoss('verdant_brink_day_securing_verdant_brink', "Day: Securing Verdant Brink", "Verdant Brink", _every(_t(0, 30), 120),
      expansion: Expansion.hot),
  WorldBoss('auric_basin_defending_tarir_pylons', "Defending Tarir (Pylons)", "Auric Basin", _every(_t(1, 30), 120),
      expansion: Expansion.hot),
  WorldBoss('auric_basin_challenges', "Challenges", "Auric Basin", _every(_t(0, 45), 120),
      expansion: Expansion.hot),
  WorldBoss('auric_basin_battle_in_tarir_octovine', "Battle in Tarir (Octovine)", "Auric Basin", _every(_t(1, 0), 120),
      expansion: Expansion.hot),
  WorldBoss('tangled_depths_advancing_across_tangled_root', "Advancing Across Tangled Roots (Outposts)", "Tangled Depths", _every(_t(0, 50), 120),
      expansion: Expansion.hot),
  WorldBoss('tangled_depths_king_of_the_jungle_chak_geren', "King of the Jungle (Chak Gerent)", "Tangled Depths", _every(_t(0, 30), 120),
      expansion: Expansion.hot),
  WorldBoss('dragon_s_stand_start_advancing_on_the_blight', "Start advancing on the Blighting Towers", "Dragon's Stand", _every(_t(1, 30), 120),
      expansion: Expansion.hot),
  ...
  WorldBoss('elon_riverlands_doppelganger', "Doppelganger", "Elon Riverlands", _every(_t(1, 55), 120),
      expansion: Expansion.pof),
  WorldBoss('elon_riverlands_the_path_to_ascension_augury', "The Path to Ascension: Augury Rock", "Elon Riverlands", _every(_t(1, 30), 120),
      expansion: Expansion.pof),
  ...
  // Living World
  WorldBoss('dry_top_crash_site', "Crash Site", "Dry Top", _every(_t(0, 0), 60),
      expansion: Expansion.lws),
  WorldBoss('dry_top_sandstorm', "Sandstorm", "Dry Top", _every(_t(0, 40), 60),
      expansion: Expansion.lws),
  ...
  WorldBoss('domain_of_istan_palawadan', "Palawadan", "Domain of Istan", _every(_t(1, 45), 120),
      expansion: Expansion.lws),
  WorldBoss('jahai_bluffs_escorts', "Escorts", "Jahai Bluffs", _every(_t(1, 0), 120),
      expansion: Expansion.lws),
  ...
  WorldBoss('eye_of_the_north_twisted_marionette', "Twisted Marionette", "Eye of the North", _every(_t(0, 0), 120),
      expansion: Expansion.lws),
  WorldBoss('eye_of_the_north_battle_for_lion_s_arch', "Battle For Lion's Arch", "Eye of the North", _every(_t(0, 30), 120),
      expansion: Expansion.lws),
  WorldBoss('eye_of_the_north_tower_of_nightmares', "Tower of Nightmares", "Eye of the North", _every(_t(1, 30), 120),
      expansion: Expansion.lws),

  // Icebrood Saga
  WorldBoss('grothmar_valley_effigy', "Effigy", "Grothmar Valley", _every(_t(0, 10), 120),
  ...
  WorldBoss('the_echovald_wilds_aspenwood', "Aspenwood", "The Echovald Wilds", _every(_t(1, 40), 120),
      expansion: Expansion.eod),
  WorldBoss('dragon_s_end_jade_maw', "Jade Maw", "Dragon's End", [_t(0, 5), _t(0, 45), _t(2, 5), _t(2, 45), _t(4, 5), _t(4, 45), _t(6, 5), _t(6, 45), _t(8, 5), _t(8, 45), _t(10, 5), _t(10, 45), _t(12, 5), _t(12, 45), _t(14, 5), _t(14, 45), _t(16, 5), _t(16, 45), _t(18, 5), _t(18, 45), _t(20, 5), _t(20, 45), _t(22, 5), _t(22, 45)],
      expansion: Expansion.eod),
  WorldBoss('dragon_s_end_the_battle_for_the_jade_sea', "The Battle for the Jade Sea", "Dragon's End", _every(_t(1, 0), 120),
      expansion: Expansion.eod),

  // Secrets of the Obscure
  WorldBoss('skywatch_archipelago_unlocking_the_wizard_s_', "Unlocking the Wizard's Tower", "Skywatch Archipelago", _every(_t(1, 0), 120),
  ...
  WorldBoss('wizard_s_tower_target_practice', "Target Practice", "Wizard's Tower", _every(_t(1, 0), 120),
      expansion: Expansion.soto),
  WorldBoss('wizard_s_tower_target_practice_fly_by_night', "Target Practice & Fly by Night", "Wizard's Tower", _every(_t(1, 40), 120),
      expansion: Expansion.soto),
  ...
  WorldBoss('starlit_weald_secrets_of_the_weald', "Secrets of the Weald", "Starlit Weald", _every(_t(1, 40), 120),
      expansion: Expansion.voe),
  WorldBoss('eternity_s_garden_shackles_of_the_ancients', "Shackles of the Ancients", "Eternity's Garden", _every(_t(1, 15), 120),
      expansion: Expansion.voe),
  WorldBoss('leyspring_hollows_depths_of_cruelty', "Depths of Cruelty", "Leyspring Hollows", _every(_t(2, 0), 180),
      expansion: Expansion.voe),
  WorldBoss('convergence_nexus_of_eternity', "Convergence: Nexus of Eternity", "Nexus of Eternity", _every(_t(1, 0), 180),
      expansion: Expansion.voe),
];
